                ...
                <div class="col-11">
                    ...
                    <div class="menulink">
                        <nav class="nav flex-column text-right">
                            <a class="nav-link semibold" href="#">Beranda</a>
                            <a class="nav-link semibold" href="#">Artikel</a>
                            <a class="nav-link semibold" href="#">Rekrutmen</a>
                        </nav>
                    </div>
                </div>
                <div class="col-11">
                    <div class="fixed-bottom mb-5">
                        <div class="d-flex justify-content-center">
                            ...
                            <div>
                                <a class="nav-link" href="#"><img src="assets/line.svg" alt="" width="24px" height="24px"></a>
                            </div>
                            <div>
        ...
        <div class="row justify-content-center p-0 pt-4 mx-1">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-item nav-link active semibold" href="index.html">Beranda<span
                            class="sr-only">(current)</span></a>
                    <a class="nav-item nav-link semibold" href="#">Artikel</a>
                    <a class="nav-item nav-link semibold" href="rekrutmen.html">Rekrutmen</a>
                </div>
            </div>
            </nav>
        </div>
